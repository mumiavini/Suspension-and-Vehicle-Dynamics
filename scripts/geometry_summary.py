...
#
# INBOARD (chassis). Shares the LCA rear bracket: same X = -1460 and same
# Y = 175, sitting 39.5 mm above it. Two consequences the chassis team asked
# for, in one point:
...
# Z is the bump-steer knob and X is very nearly not: over X = -1460 to -1400
# the peak toe excursion moves 0.0128 -> 0.0119 deg, while +/-11 mm of Z is
# worth +/-0.5 deg. Z = 169 leaves a linear rate of -0.00014 deg/mm; the exact
# null is 169.058, which is far inside the 0.5 mm build tolerance, so the round
# number is the honest one. `toe_link_z_for_zero_bump_steer` re-solves it if
# the geometry moves.
#
...
REAR_TOE_LINK_INBOARD: Pt = (-1460.0, 175.0, 169.0)
